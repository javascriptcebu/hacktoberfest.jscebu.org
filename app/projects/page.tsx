import { Eye, GithubIcon, ExternalLink, GitBranch } from "lucide-react";
import { getProjectViews, getProjectsByYear, getApprovedSubmittedProjects } from "./utils";
        ...
        {submittedProjects.length > 0 && (
          <>
            ...
            <div className="max-w-2xl mx-auto lg:mx-0">
              ...
              <p className="mt-4 text-base text-zinc-400">
                Open source projects submitted by our community members for Hacktoberfest {YEAR}.
            ...
            <Card>
              <div className="p-8 text-center">
                ...
                <p className="text-zinc-400 mb-4">
                  Submit your open source project and get contributions from the community!
                </p>
                <Link
                  href="/submit"
