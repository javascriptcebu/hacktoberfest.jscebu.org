        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="p-6 bg-east-bay/30 border border-blue-violet/30 rounded-lg text-left">
              ...
              <ul className="text-xs text-space-haze space-y-1">
          ...
          <div className="mt-12 p-8 bg-east-bay/30 border border-blue-violet/30 rounded-lg">
            <h2 className="text-2xl font-bold text-space-white mb-4">Sign Up to Volunteer</h2>
            <p className="text-space-dust mb-6">
              Join our amazing team of volunteers and help make Hacktoberfest Cebu 2025 unforgettable!
            </p>
            <button className="px-8 py-4 bg-lavender text-void font-medium rounded-lg hover:bg-melrose transition">
              Become a Volunteer
            </button>
