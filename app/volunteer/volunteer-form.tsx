...
export function VolunteerForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // This should not happen as form is only shown when authenticated
    if (!isAuthenticated) {
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        setSubmitStatus({
          type: "success",
          message:
            "Application submitted successfully! We'll contact you soon with more details.",
        });
        setFormData({
          name: "",
          email: userEmail || "",
  ...
  const roleDescriptions = {
    "speaker-coordinator":
      "Communicate with speakers, coordinate presentations and slides, assist speakers on-site, manage tokens of appreciation and certificates.",
    emcee:
      "Host event sessions, manage timing, prevent dead air, moderate breakout rooms (2 per room).",
    "opensource-coordinator":
      "Manage list of open source projects, contact maintainers, coordinate lightning talks.",
    "judging-committee":
    ...
    creatives:
      "Design event assets, create visual materials, support branding and design needs.",
    "tech-team":
      "Manage audio/video equipment, coordinate WiFi with venue, handle technical setup for breakout sessions.",
    livestreaming:
      "Manage live streaming for main and breakout sessions, handle recording for breakout rooms.",
    logistics:
      "Handle physical arrangements, crowd control, Q&A microphone management, food coordination, general event support.",
    registration:
      "Manage event registration, check-in attendees, handle on-site registration queries.",
    photographer:
      "Capture event moments, cover main and breakout sessions, document the event visually.",
    socmed:
      "Live social media coverage, conduct on-site interviews, coordinate with livestream team for content.",
  };
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="p-3 bg-east-bay/20 rounded-lg border border-blue-violet/20">
                      ...
                      <span className="text-space-dust ml-2">
                        {roleDescriptions["emcee"]}
                      </span>
                    </div>
                    <div className="p-3 bg-east-bay/20 rounded-lg border border-blue-violet/20">
                      <span className="font-semibold text-melrose">
                        Open Source Coordinator (2):
                      </span>
                      <span className="text-space-dust ml-2">
                        {roleDescriptions["opensource-coordinator"]}
                      </span>
                    </div>
                    <div className="p-3 bg-east-bay/20 rounded-lg border border-blue-violet/20">
                      <span className="font-semibold text-melrose">
                      ...
                      <span className="text-space-dust ml-2">
                        {roleDescriptions["judging-committee"]}
                      </span>
                    </div>
                    <div className="p-3 bg-east-bay/20 rounded-lg border border-blue-violet/20">
                      <span className="font-semibold text-melrose">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="p-3 bg-east-bay/20 rounded-lg border border-blue-violet/20">
                      ...
                      <span className="text-space-dust ml-2">
                        {roleDescriptions["tech-team"]}
                      </span>
                    </div>
                    <div className="p-3 bg-east-bay/20 rounded-lg border border-blue-violet/20">
                      <span className="font-semibold text-melrose">
                        Livestreaming Team (4):
                      </span>
                      <span className="text-space-dust ml-2">
                        {roleDescriptions["livestreaming"]}
                      </span>
                    </div>
                  </div>
                </div>
      ...
      <Card>
        <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
          ...
          <div>
            ...
            >
              ...
              <optgroup label="Coordination">
                <option value="speaker-coordinator">
                  Speaker Coordinator (2 positions)
                </option>
                <option value="emcee">Emcee/Host (4 positions)</option>
                <option value="opensource-coordinator">
                  Open Source Maintainer Coordinator (2 positions)
                </option>
                <option value="judging-committee">
                  Judging Committee (1 position)
                </option>
          ...
          <div>
            ...
            >
              Technical Skills{" "}
              <span className="text-space-haze">(optional)</span>
            </label>
            <input
              type="text"
              id="skills"
            ...
            />
            <p className="mt-1 text-xs text-space-haze">
              List programming languages, frameworks, or tools you're familiar
              with
            </p>
          </div>
          ...
          <div className="text-sm text-space-dust/80">
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>
                You're committed to volunteering for Hacktoberfest Cebu 2025
              </li>
