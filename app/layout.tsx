...
export const metadata: Metadata = {
	...
	description:
		"Join 100+ developers for Cebu's biggest open source celebration. October 5-26, 2025. 21-day hackathon, workshops from 15+ partner communities, exclusive swag, and prizes.",
	keywords: [
		"Hacktoberfest",
		"Hacktoberfest Cebu",
		"Open Source",
	...
	twitter: {
		title: "Hacktoberfest Cebu 2025 | Build. Contribute. Win.",
		description: "Join 100+ developers for Cebu's biggest open source celebration. October 5-26, 2025.",
				...
				<script
					...
					dangerouslySetInnerHTML={{
						__html: JSON.stringify({
							...
							"description": "Join 100+ developers for Cebu's biggest open source celebration. 21-day hackathon, workshops from 15+ partner communities, exclusive swag, and prizes.",
